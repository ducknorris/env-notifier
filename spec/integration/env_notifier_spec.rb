...
describe Rack::EnvNotifier do
  ...
  describe 'with a notify set on true' do
    ...
    it 'has the Notification in the body' do
      last_response.body.include?('<div id="env-notifier" style="position: fixed; top: 0; right: 0; left: 0; background: rgba(150, 50, 50, .7); color: #fff; text-align: center; font-size: 16px; font-weight: bold; padding: 2px; z-index: 999999">warning!!! hot zone!!!</div>').should be_true
    end
    ...
    it 'has the Notification in the body' do
      last_response.body.include?('<div id="env-notifier" style="position: fixed; top: 0; right: 0; left: 0; background: rgba(150, 50, 50, .7); color: #fff; text-align: center; font-size: 16px; font-weight: bold; padding: 2px; z-index: 999999">warning!!! hot zone!!!</div>').should_not be_true
    end
...
<!-- Safety first -->
<div id="env-notifier" style="position: fixed; top: 0; right: 0; left: 0; background: rgba(150, 50, 50, .7); color: #fff; text-align: center; font-size: 16px; font-weight: bold; padding: 2px; z-index: 999999">warning!!! hot zone!!!</div>
